...
CMD_PARSE_WHITELIST = ['version', 'update', 'url', 'file', 'verify', 'attack', 'shell', 'cookie', 'host', 'referer',
                       ...
                       'login-user', 'login-pass', 'dork', 'dork-shodan', 'dork-censys', 'dork-zoomeye', 'dork-fofa', 'dork-fofac', 'dork-google',
                       'max-page', 'search-type', 'shodan-token', 'fofa-user', 'fofa-token', 'fofa-cookie', 'vul-keyword', 'ssv-id',
